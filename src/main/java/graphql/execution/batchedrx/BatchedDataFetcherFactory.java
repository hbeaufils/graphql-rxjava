 ...
 * 
 * This factory's based on the original {@link graphql.execution.batched.BatchedDataFetcherFactory}
 * but uses a specific UnbatchedDataFetcher that supports Rx Observable unbatched results.
 */
